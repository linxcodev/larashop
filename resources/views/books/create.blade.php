  ...
  <div class="row">
    <div class="col-md-8">
      ...
      class="shadow-sm p-3 bg-white">
        ...
        <input type="file" class="form-control {{$errors->first('cover') ? "is-invalid" : ""}} "
        name="cover">
        ...
        {{$errors->first('stock') ? "is-invalid" : ""}} " id="stock" name="stock"
        min=0 value=0>
        ...
        {{$errors->first('author') ? "is-invalid" : ""}} " name="author"
