...
class BookController extends Controller
{
    ...
    public function store(Request $request)
    {
      ...
      if($request->get('save_action') == 'PUBLISH'){
        return redirect()->route('books.create')->with('status',
               'Book successfully saved and published');
      } else {
        return redirect()->route('books.create')->with('status',
               'Book saved as draft');
      }
    ...
    public function update(Request $request, $id)
    {
      ...
      return redirect()->route('books.edit', ['id'=>$book->id])->with('status',
